...
public class api {
    ...
    @GetMapping("/letturaTransazioniUtente")
    public ListaTransazioniResponse getAccountTransactions_prova(@RequestHeader("Content-Type") MediaType contentType,
                                                                 @RequestHeader("Auth-Schema") String authSchema,
                                                                 @RequestHeader("Api-Key") String apiKey,
                                                                 @RequestParam Long accountId,
                                                                 @RequestParam String fromAccountingDate,
        ...
        headers.set("Api-Key", apiKey);
        logger.info("chiamata al service con getAccountTransactions");
        return fabrickService.getAccountTransactionsUtente(headers, accountId,fromAccountingDate,toAccountingDate);
    }
